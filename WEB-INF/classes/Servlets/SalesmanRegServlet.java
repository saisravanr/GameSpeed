...
public class SalesmanRegServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			if (cpassword.equals(password)) {
				...
				pw.println("<br><a href='Rlogin.html'>Click here to login</a>");
				pw.println("</html>");
			} else {
				pw.println("<html>");
				pw.println("<head><title>Incorrect Password</title></head>");
				pw.println("<body align='center'>Passwords do not match<br>");
				pw.println("<br><a href='Rreg.html'>Click here to re-enter</a>");
				pw.println("</html>");
			}
		} catch (Exception e) {
			e.printStackTrace();
